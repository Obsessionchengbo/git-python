...
def face_detect_demo():
    ...
    face_detect = cv.CascadeClassifier('F:\\download\\opencv\\opencv-4.5.2\\data\\haarcascades\\haarcascade_frontalface_alt2.xml')
    face = face_detect.detectMultiScale(gray,1.01,50,0,(10,10),(300,300))
    for x,y,w,h in face:
